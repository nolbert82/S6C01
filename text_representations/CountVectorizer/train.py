...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_dir",
        type=Path,
        default=Path("text_representations/CountVectorizer/saved_model"),
        help="Directory where the trained CountVectorizer will be saved.",
    )
    parser.add_argument(
        "--progress_every",
        type=int,
...
def main() -> None:
    ...
    model_path = args.output_dir / "count_vectorizer.pkl"
