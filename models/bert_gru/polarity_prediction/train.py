...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train a frozen DistilBERT + GRU model for polarity prediction."
    )
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output_dir",
        type=Path,
        default=Path("models/bert_gru/polarity_prediction/saved_model"),
...
def main() -> None:
    ...
    model_path = args.output_dir / "bert_gru_polarity_model.pt"
    bundle = {
