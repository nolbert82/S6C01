...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Test shared TFIDF + RandomForest polarity model on the testing dataset."
    )
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--model_dir",
        type=Path,
        default=Path("models/TFIDF_randomforest/polarity_prediction/saved_model"),
        help="Directory containing the trained RandomForest model.",
    )
    parser.add_argument(
        "--results_path",
        type=Path,
        default=Path("models/TFIDF_randomforest/polarity_prediction/results.txt"),
