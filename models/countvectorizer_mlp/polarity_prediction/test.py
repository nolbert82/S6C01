...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Test shared CountVectorizer + PyTorch MLP polarity model on the testing dataset."
    )
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--results_path",
        type=Path,
        default=Path("models/countvectorizer_mlp/polarity_prediction/results.txt"),
