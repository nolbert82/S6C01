...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Test shared CountVectorizer + PyTorch MLP model on the testing dataset."
    )
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--results_path",
        type=Path,
        default=Path("models/countvectorizer_mlp/score_prediction/results.txt"),
...
def main() -> None:
    ...
    model_path = args.model_dir / "mlp_score_model.pt"
