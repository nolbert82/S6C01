...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Test frozen DistilBERT + CNN polarity model on the testing dataset."
    )
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--results_path",
        type=Path,
        default=Path("models/bert_cnn/polarity_prediction/results.txt"),
...
def main() -> None:
    ...
    model_path = args.model_dir / "bert_cnn_polarity_model.pt"
